function [net_work_output_Jperkg, overall_efficiency] = function_RC_economizer_input_high_T_high_P_4_C_mixture_WF (expander_isentropic_efficiency, pump_isentropic_efficiency, ambient_T_K, economizer_effectiveness, T4_K, P2_kPa, mass_composition, substance1, substance2, substance3, substance4)

% Organic Rankine Cycle with economizer, using a mixture as working fluid
...
if (P2_kPa >= P1_kPa + 100) && (high_T_limit_K >= dew_point_T_low_P_K + 10)      % Feasible conditions.
    ...
    if T4_K >= high_P_max_s_T_K
        ...
        h5prime_Jperkg = refpropm ('H', 'P', P5_kPa, 'S', s5prime_JperKkg, substance1, substance2, substance3, substance4, mass_composition);
        ...
        T5_K = refpropm('T', 'P', P5_kPa, 'H', h5_Jperkg, substance1, substance2, substance3, substance4, mass_composition);
        ...
        h2prime_Jperkg = refpropm('H', 'P', P2_kPa, 'S', s2prime_JperKkg, substance1, substance2, substance3, substance4, mass_composition);
        ...
        T2_K = refpropm('T', 'P', P2_kPa, 'H', h2_Jperkg, substance1, substance2, substance3, substance4, mass_composition);
